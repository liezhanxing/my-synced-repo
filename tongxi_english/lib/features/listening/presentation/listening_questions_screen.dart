...
/// Listening comprehension questions screen
/// 
/// Displays multiple choice questions based on listening content
/// with score and feedback at the end.
class ListeningQuestionsScreen extends ConsumerWidget {
  const ListeningQuestionsScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          '听力理解 (${controller.currentQuestionIndex + 1}/${exercise.questions.length})',
          style: TextStyle(
            fontSize: 18,
      ...
      body: Column(
        children: [
          // Progress indicator
          _buildQuestionProgress(exercise, controller),
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // Question card
                  _buildQuestionCard(exercise, controller, controllerNotifier),
                  
                  const SizedBox(height: 24),
                  
                  // Navigation buttons
                  _buildNavigationButtons(context, exercise, controller, controllerNotifier),
                ],
              ),
            ),
          ),
  ...
  Widget _buildQuestionProgress(ListeningModel exercise, ListeningState controller) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: List.generate(exercise.questions.length, (index) {
              final isCurrent = index == controller.currentQuestionIndex;
              final isAnswered = controller.userAnswers.containsKey(exercise.questions[index].id);
              
              return GestureDetector(
                onTap: () => ref.read(listeningControllerProvider.notifier).goToQuestion(index),
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isCurrent
                        ...
                        : isAnswered
                            ? ModuleColors.listening.withOpacity(0.5)
                            : AppColors.divider,
          ...
          // Progress text
          Text(
            '已答 ${controller.userAnswers.length}/${exercise.questions.length} 题',
            style: TextStyle(
              fontSize: 12,
  ...
  Widget _buildQuestionCard(
    ...
    final question = exercise.questions[controller.currentQuestionIndex];
          ...
          Row(
            children: [
              Container(
                ...
                child: Text(
                  '问题 ${controller.currentQuestionIndex + 1}',
                  style: const TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
  ...
  Widget _buildOptionCard({
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: isSelected ? ModuleColors.listening.withOpacity(0.1) : Colors.white,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: isSelected ? ModuleColors.listening : AppColors.divider,
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              height: 32,
              decoration: BoxDecoration(
                color: isSelected ? ModuleColors.listening : AppColors.surfaceLight,
  ...
  Widget _buildNavigationButtons(
    ...
    final isLastQuestion = controller.currentQuestionIndex == exercise.questions.length - 1;
          ...
          child: isLastQuestion
              ? AnimeButton(
                  ...
                  gradient: LinearGradient(
                    colors: canSubmit
                        ? [ModuleColors.listening, AppColors.accentOrange]
                ...
                children: [
                  ...
                  Expanded(
                    child: AnimeButton(
                      text: '返回列表',
                      onPressed: () {
                        controllerNotifier.clearSelectedExercise();
                        context.pop();
                        context.pop();
                      },
                      height: 50,
